...
public class WelcomePanel extends AbstrPanel{
	...
	private JPanel getFilePanel(){
		...
		panel = new JPanel();
		panel.add(new JLabel("Result file: " + XmlService.FILE_PATH + XmlService.XML_RESULT_FILE_NAME + ". Xsl files: " + XmlService.FILE_PATH + XmlService.XSL_DATA_FILE_NAME));
		panel.add(new JLabel(" and " + XmlService.FILE_PATH + StreamService.XSL_FILE_NAME));
		return panel;
	...
	private String readNameFromXmlFile(){
		...
		String fileLocation = XmlService.FILE_PATH + XmlService.XML_RESULT_FILE_NAME;
